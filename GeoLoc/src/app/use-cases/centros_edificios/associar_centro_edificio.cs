...
{
    public class associar_centro_edificio
    {
        private readonly ICentroEdificioRepository _centroEdificioRepository;
        public associar_centro_edificio(ICentroEdificioRepository centroEdificioRepository)
        {
        ...
        public async Task Execute(int id_centro, int id_edificio)
        {
            ...
            await _centroEdificioRepository.AssociarCentroEdificio(id_centro, id_edificio);
        }
    }
}
